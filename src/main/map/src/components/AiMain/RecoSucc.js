...
export default function RecoSucc(props) {
    ...
    return (
        <div id="conResult">
            ...
            <div class="content_result_area" style={{width: "1380px", height: "450px"}} >
            {
    ...
    return(
        <div class="content_result_one" >
            <a> <img src={houseReplaceImg} onClick={(e) => {
                navigate(`/ai/homeDetail/${props.succession.articleNo}`,{
                    state: {
            ...
            <div class="result_address_text">
                ...
                <span class="result_address">{props.succession.address}{props.succession.addressDetail}</span>
            </div>
        </div>
    )
}