...
const OpenChannelListContext = /*#__PURE__*/React__default.createContext({
...
const OpenChannelListProvider = _ref => {
  ...
  // dux
  const [openChannelListStore, openChannelListDispatcher] = useReducer(reducer, openChannelListInitialState);
  const {
    allChannels,
    currentChannel,
    fetchingStatus,
  ...
  useEffect(() => {
    ...
    subscriber === null || subscriber === void 0 ? void 0 : subscriber.set(PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe(PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, channel => {
      openChannelListDispatcher({
  ...
  return /*#__PURE__*/React__default.createElement(OpenChannelListContext.Provider, {
    value: {
      // props
...
export { OpenChannelListProvider as O, OpenChannelListFetchingStatus as a, OpenChannelListActionTypes as b, OpenChannelListProvider$1 as c, useOpenChannelListContext as u };
//# sourceMappingURL=OpenChannelListProvider-426cfb39.js.map
