...
function changeTypeToIconComponent(type) {
  switch (type) {
    ...
    case Types.AUDIO_ON_LINED:
      return /*#__PURE__*/React__default["default"].createElement(SvgIconAudioOnLined, null);
    case Types.BAN:
...
function Icon(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: [...(Array.isArray(className) ? className : [className]), 'sendbird-icon', changeTypeToIconClassName(type), changeColorToClassName(fillColor)].join(' '),
    role: "button",
    onClick: onClick,
    onKeyDown: onClick,
    tabIndex: "0",
...
Icon.propTypes = {
  ...
  type: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(Object.keys(Types)), PropTypes__default["default"].string]).isRequired,
